...
object RouteOverviewUtil {
    ...
    lateinit var THE_UNSAFE: sun.misc.Unsafe

    init {
        try {
            THE_UNSAFE = AccessController.doPrivileged(PrivilegedExceptionAction {
...
private val Any.methodName: String?
    get() {
        ...
        val overrideFieldOffset = RouteOverviewUtil.THE_UNSAFE.objectFieldOffset(overrideField)
        RouteOverviewUtil.THE_UNSAFE.putBoolean(getConstantPool, overrideFieldOffset, true)
        RouteOverviewUtil.THE_UNSAFE.putBoolean(getSize, overrideFieldOffset, true)
        RouteOverviewUtil.THE_UNSAFE.putBoolean(getMemberRefInfoAt, overrideFieldOffset, true)
        ...
        for (i in constantPoolSize downTo 0) {
            try {
                ...
                val name = (getMemberRefInfoAt.invoke(constantPool) as Array<String>)[1]
